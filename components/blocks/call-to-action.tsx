    ...
    return (
        <Section background={data.background!}>
            <div className="max-w-xl mx-auto text-center">
                <h2
                    className="font-headline text-5xl md:text-6xl text-on-surface mb-8"
                    data-tina-field={tinaField(data, "title")}
                >
                    {data.title}
                </h2>
                <p
                    className="font-body text-on-surface-variant leading-relaxed italic mb-12"
...
export const textBlockSchema: Template = {
    ...
    label: "Text Content",
    ui: {
        previewSrc: "/blocks/text-content.png",
        defaultItem: {
            background: "bg-surface-container",
            title: "Join the Inner Circle",
            description:
                "Receive private invitations to our upcoming retreats and seasonal reflections on growth and glowing from within.",
            actions: [
                {
                    type: "internal",
